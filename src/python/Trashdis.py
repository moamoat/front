...
solver = pywraplp.Solver('자원회수시설', 
    pywraplp.Solver.CBC_MIXED_INTEGER_PROGRAMMING)
from openrouteservice import client, places
import csv
garbage_data = pd.read_csv("C:/Users/byunstag/Desktop/쓰레기 분배알고리즘/2021 예측 구별 쓰레기 배출량.csv",encoding='cp949')
기존_균등량= pd.read_csv("C:/Users/byunstag/Desktop/쓰레기 분배알고리즘/2021 시설별 반입량,용량.csv",encoding='cp949')
비용=pd.read_csv("C:/Users/byunstag/Desktop/총비용.csv",encoding='UTF-8')
기존비용=pd.read_csv("C:/Users/byunstag/Desktop/기존총비용.csv", encoding='UTF-8')
import json
from openrouteservice import client, places
...
data = pd.read_csv("C:/Users/byunstag/Desktop/openroute service distance - 복사본.csv")
data2 = pd.read_csv("C:/Users/byunstag/Desktop/openroute service distance2.csv")
data.reset_index(drop=True,inplace=True)
cannon = input("경도를 넣으세요")
minch = input("위도를 넣으세요")
sibal = open("C:/Users/byunstag/Desktop/openroute service distance - 복사본.csv",'a', newline='')
...
with open("C:/Users/byunstag/Desktop/openroute service distance - 복사본.csv", "r",newline="",encoding='UTF8') as f:
    data= list(csv.reader(f))
with open("C:/Users/byunstag/Desktop/openroute service distance - 복사본.csv", "w",newline="",encoding='UTF8') as f:
    writer = csv.writer(f)
    for row in data:
        if row[0] !='new place':
            writer.writerow(row)